...
const KitchenModel = () => {
	...
	camera.position.set(0 * scale, 3 * scale, -7 * scale);
	camera.lookAt(0, 0, 0);
				...
				<Suspense fallback={<Loading />}>
					<Canvas>
						...
						<Cube
							position={[-9, 1.4, 4]}
							size={[3, 7, 2]}
							goTo={new THREE.Vector3(-7, 1.4, -2)}
							lookAt={new THREE.Vector3(-9, 1.4, 4)}
						...
						<Cube
							position={[-5.7, 1.4, 1]}
							size={[0.6, 2, 1]}
							goTo={new THREE.Vector3(-5, 1.4, -2)}
							lookAt={new THREE.Vector3(-5.7, 1.4, 1)}
